(function () {
    ...
    notifier.modal(`<h4 class="font-medium mb-1 text-defaulttextcolor dark:text-defaulttextcolor/70 text-xl">Welcome To Tailwind Admin Template </h4><small class="text-gray-500 text-sm">Click outside the modal window to close it.</small>`, 'demo')
    })
