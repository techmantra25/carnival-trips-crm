(function () {
    ...
    var options = {
        ...
        colors: ["rgb(1, 98 ,232)", "#23b7e5", "#f5b849"],
        stroke: {
            show: true,
            width: 2,
            colors: ['transparent']
    ...
    var options = {
        ...
        colors: ["rgb(1, 98 ,232)", "#23b7e5", "#f5b849", "#e6533c"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var options = {
        ...
        legend: {
            ...
            markers: {
                fillColors: ['rgb(1, 98, 232)', 'rgb(95 ,109 ,136)']
            }
        },
        xaxis: {
            labels: {
    ...
    var colors = ['rgb(1, 98 ,232)', 'rgb(95 ,109 ,136)', 'rgb(251 ,188, 11)', 'rgb(0 ,185, 255)', 'rgb(238, 51, 94)', 'rgb(34 ,192, 60)', '#5b67c7'];
    ...
    var options = {
        ...
        colors: ['rgb(1, 98 ,232)', 'rgb(95 ,109 ,136)', 'rgb(251 ,188, 11)', 'rgb(0 ,185, 255)', 'rgb(238, 51, 94)', 'rgb(34 ,192, 60)', '#a65e76'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
