...
<body style="background-size: cover; background-position: center center; background-repeat: no-repeat; padding: 0; margin: 0;">
    <div style="background: rgba(0,0,0,0.5); width: 100%; min-height: 100vh;">
        <div style="
            width:100%;
            background-image: url('{{ public_path('assets/final_quotation_images/logo2.jpg') }}');
    ...
    <div style="background: rgba(0,0,0,0.5); width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0"
         style="width:100%;
           background-image: url('{{ public_path('assets/final_quotation_images/logo3.jpg') }}');
           background-repeat: no-repeat;
           background-position: center center;
           background-size: cover;">
            <tbody>
    ...
    <!-- page 3 -->
      <div style="background: rgba(0,0,0,0.5); width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0" 
        style="width:100%;
           background-image: url('{{ public_path('assets/final_quotation_images/logo4.jpg') }}');
           background-repeat: no-repeat;
           background-position: center center;
           background-size: cover;">
            <tbody>
    ...
    <div style="background: #fff; width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0" style="width: 100%; border: none;">
            <tbody>
                <tr>
                    <td>
                        <div style="background-image: url('{{ public_path('assets/final_quotation_images/logo5.jpg') }}'); background-size: cover; background-position: center center; background-repeat: no-repeat; width: 100%; height: 40vh;"></div>
                    </td>
                </tr>
                <tr><td style="padding: 10px 0;"></td></tr>
                <tr>
    ...
    <div style="background: #fff; width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0" style="width: 100%; border: none;">
            <tbody>
                <tr>
                    <td>
                        <div style="background-image: url('{{ public_path('assets/final_quotation_images/logo6.jpg') }}'); background-size: cover; background-position: center center; background-repeat: no-repeat; width: 100%; height: 40vh;"></div>
                    </td>
                </tr>
                <tr><td style="padding: 10px 0;"></td></tr>
                <tr>
    ...
    <div style="background: #fff; width: 100%; min-height: 100vh;">
        ...
        <tbody>
            <tr>
                <td>
                    <div style="background-image: url('{{ public_path('assets/final_quotation_images/logo7.jpg') }}'); background-size: cover; background-position: center center; background-repeat: no-repeat; width: 100%; height: 40vh;"></div>
                </td>
            </tr>
            <tr><td style="padding: 10px 0;"></td></tr>
            <tr>
    ...
    <!-- page 7 -->
     <div style="background: rgba(0,0,0,0.5); width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0" style="width:100%;
           background-image: url('{{ public_path('assets/final_quotation_images/logo8.jpg') }}');
           background-repeat: no-repeat;
           background-position: center center;
           background-size: cover;">
            <tbody>
    ...
    <!-- page 8 -->
     <div style="background: rgba(0,0,0,0.5); width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0" style="width:100%;
           background-image: url('{{ public_path('assets/final_quotation_images/logo9.jpg') }}');
           background-repeat: no-repeat;
           background-position: center center;
           background-size: cover;">
            <tbody>
    ...
    <!-- page 10 -->
     <div style="background: rgba(0,0,0,0.5); width: 100%; min-height: 100vh;">
        <table cellspacing="0" cellpadding="0"  style="width:100%;
           background-image: url('{{ public_path('assets/final_quotation_images/logo10.jpg') }}');
           background-repeat: no-repeat;
           background-position: center center;
           background-size: cover;">
            <tbody>
