                ...
                <div class="container mx-auto px-4">
                    <form action="{{ route('admin.leads.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                <label for="departure_date" class="block text-sm font-medium text-gray-700">Travel Date</label>
                            ...
                            <div>
                                ...
                                <x-input-field type="text" name="source_type" placeholder="Source Type" ariaLabel="Source Type" class="mb-3 placeholder:text-textmuted text-sm {{ $errors->has('source_type') ? '!border-danger focus:border-danger focus:ring-danger' : '' }}" size="lg" value="B2B" readonly/>
                            </div>
