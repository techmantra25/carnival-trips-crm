...
<div class="md:flex block items-center justify-between mb-6 mt-1  page-header-breadcrumb">
    ...
    <div class="ti-btn-list">
        ...
        @else
            <a href="{{route('admin.cost_calculator.query_list')}}" class="ti-btn ti-btn-danger-full !py-1 !px-2 ti-btn-wave  me-[0.375rem]"><i class="fa-solid fa-caret-left"></i>Back</a>
        @endif
    </div>
</div>
    <!-- Start:: row-10 -->
    <livewire:itinerary.create-query-itinerary :encryptedId="$id" />
