...
<!-- Select2 CSS -->
    ...
    <div class="md:flex block items-center justify-between mb-6 mt-1  page-header-breadcrumb">
        ...
        <div class="ti-btn-list">
            <a href="{{$back_url}}" class="ti-btn ti-btn-danger-full !py-1 !px-2 ti-btn-wave  me-[0.375rem]"><i class="fa-solid fa-caret-left"></i>Back</a>
        </div>
    </div>
        <!-- Start:: row-10 -->
    <livewire:itinerary.cost-calculator-query-edit :encryptedLeadId="$id" :back_url="$back_url"/>
<!-- End:: row-10 -->
@endsection
@section('scripts')
@endsection
