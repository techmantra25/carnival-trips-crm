...
<div class="md:flex block items-center justify-between mb-6 mt-1  page-header-breadcrumb">
    ...
    <div class="ti-btn-list">
            <a href="{{route('admin.itinerary.lead.customization')}}" class="ti-btn ti-btn-danger-full !py-1 !px-2 ti-btn-wave  me-[0.375rem]"><i class="fa-solid fa-caret-left"></i>Back</a>
    </div>
</div>
    <!-- Start:: row-10 -->
<livewire:itinerary.lead-itinerary-customization />
