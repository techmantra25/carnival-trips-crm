...
<div class="md:flex block items-center justify-between mb-6 mt-1  page-header-breadcrumb">
    ...
    {{-- <div class="ti-btn-list">
        <a href="{{route('admin.room.category.index')}}" class="ti-btn ti-btn-danger-full !py-1 !px-2 ti-btn-wave  me-[0.375rem]"><i class="fa-solid fa-caret-left"></i>Back</a>
    </div> --}}
</div>
    <!-- Start:: row-10 -->
    ...
    <div class="xl:col-span-4 col-span-12">
            @if(isset($update_item))
                <div class="bg-custom_card">
                    ...
                    <div class="box-body">
                        <form action="{{route('admin.room.category.update')}}" method="post" id="update_plan">
                            @csrf
            ...
            @else
                <div class="box custom-box">
                    ...
                    <div class="box-body">
                        <form action="{{route('admin.room.category.store')}}" method="post">
                            @csrf
                            <div class="xl:col-span-4 lf:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                <x-form-field 
                                    type="text" 
