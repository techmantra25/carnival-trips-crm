                    ...
                    <form action="{{ route('admin.leads.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-input-field type="date" name="departure_date" ariaLabel="Departure Date" class="mb-3 placeholder:text-textmuted text-sm {{ $errors->has('departure_date') ? '!border-danger focus:border-danger focus:ring-danger' : '' }}" size="lg" value="{{old('departure_date')}}" min="{{ date('Y-m-d') }}"/>
