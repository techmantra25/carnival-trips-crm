			...
			<ul class="main-menu">
				...
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						...
						<li class="slide">
							<a href="{{url('index1')}}" class="side-menu__item">Ecommerce</a>
						</li>
						<li class="slide">
							<a href="{{url('index2')}}" class="side-menu__item">Crm</a>
						</li>
						<li class="slide">
							<a href="{{url('index3')}}" class="side-menu__item">Crypto</a>
						</li>
						<li class="slide">
							<a href="{{url('index4')}}" class="side-menu__item">NFT</a>
						</li>
						<li class="slide">
							<a href="{{url('index5')}}" class="side-menu__item">Analytics</a>
						</li>
						<li class="slide">
							<a href="{{url('index6')}}" class="side-menu__item">HRM</a>
						</li>
						<li class="slide">
							<a href="{{url('index7')}}" class="side-menu__item">Projects</a>
						</li>
						<li class="slide">
							<a href="{{url('index8')}}" class="side-menu__item">jobs</a>
						</li>
						<li class="slide">
							<a href="{{url('index9')}}" class="side-menu__item">Stocks</a>
						</li>
						<li class="slide">
							<a href="{{url('index10')}}" class="side-menu__item">Course</a>
						</li>
						<li class="slide">
							<a href="{{url('index11')}}" class="side-menu__item">Personal</a>
						</li>
					</ul>
				</li>
					...
					<ul class="slide-menu child1">
						...
						<li class="slide has-sub">
							...
							<ul class="slide-menu child2">
								...
								<li class="slide">
									<a href="{{url('apex-candlestick-charts')}}" class="side-menu__item">CandleStick Charts</a>
								</li>
								<li class="slide">
						...
						<li class="slide">
							<a href="{{url('chartjs')}}" class="side-menu__item">Chartjs Charts</a>
						</li>
						<li class="slide">
							<a href="{{url('echartjs')}}" class="side-menu__item">Echart Charts</a>
						</li>
					</ul>
				</li>
				<!-- End::slide -->
				...
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						...
						<li class="slide">
							<a href="{{url('draggable')}}" class="side-menu__item">Draggable Cards</a>
						</li>
						<li class="slide">
							<a href="{{url('full-calendar')}}" class="side-menu__item">Calendar</a>
						</li>
						<li class="slide">
						...
						<li class="slide">
							<a href="{{url('widgets')}}" class="side-menu__item">Widgets</a>
						</li>
						<li class="slide">
				...
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1 mega-menu">
						...
						<li class="slide">
							<a href="{{url('avatars')}}" class="side-menu__item">Avatar</a>
						</li>
						<li class="slide">
							<a href="{{url('breadcrumb')}}" class="side-menu__item">Breadcrumb</a>
						</li>
						<li class="slide">
						...
						<li class="slide">
							<a href="{{url('badge')}}" class="side-menu__item">Badge</a>
						</li>
						<li class="slide">
							<a href="{{url('dropdowns')}}" class="side-menu__item">Dropdown</a>
						</li>
						<li class="slide">
							<a href="{{url('list')}}" class="side-menu__item">List</a>
						</li>
						<li class="slide">
							<a href="{{url('listgroup')}}" class="side-menu__item">List Group</a>
						</li>
						<li class="slide">
							<a href="{{url('blockquotes')}}" class="side-menu__item">Blockquotes</a>
						</li>
						<li class="slide">
							<a href="{{url('navbar')}}" class="side-menu__item">Navbar</a>
						</li>
						<li class="slide">
				...
				<li class="slide has-sub">
					...
					<ul class="slide-menu child1">
						...
						<li class="slide">
							<a href="{{url('accordions-collpase')}}" class="side-menu__item">Accordions</a>
						</li>
						<li class="slide">
							<a href="{{url('modals-closes')}}" class="side-menu__item">Modals</a>
						</li>
						<li class="slide has-sub">
							...
							<ul class="slide-menu child2">
								<li class="slide">
									<a href="{{url('timeline')}}" class="side-menu__item">Timeline-1</a>
								</li>
								<li class="slide">
									<a href="{{url('timeline2')}}" class="side-menu__item">Timeline-2</a>
								</li>
							</ul>
						</li>
						<li class="slide">
						...
						<li class="slide">
							<a href="{{url('userlist')}}" class="side-menu__item">Userlist</a>
						</li>
						<li class="slide has-sub">
							...
							<ul class="slide-menu child2">
								...
								<li class="slide">
									<a href="{{url('blog-create')}}" class="side-menu__item">Blog Create</a>
								</li>
							</ul>
						</li>
						<li class="slide">
						...
						<li class="slide">
							<a href="{{url('skeleton')}}" class="side-menu__item">Skeleton</a>
						</li>
						<li class="slide">
