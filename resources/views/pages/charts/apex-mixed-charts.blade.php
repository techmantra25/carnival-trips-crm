...
@section('content')
                    ...
                    <div class="my-auto">
                        <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Apex Mixed Charts</h5>
                        <nav>
                        <ol class="flex items-center whitespace-nowrap min-w-0">
                            ...
                            <li class="text-[12px]"> <a class="flex items-center text-textmuted"
                                href="javascript:void(0);">Apex Mixed Charts 
                            </a> </li>
                        </ol>
                        </nav>
                    </div>
...
@section('scripts')
        ...
        <script src="{{asset('build/assets/apexcharts-mixed.js')}}"></script>
