...
@section('content')
                    ...
                    <div class="my-auto">
                        <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Widgets</h5>
                        <nav>
                        <ol class="flex items-center whitespace-nowrap min-w-0">
                            ...
                            <li class="text-[12px]"> <a class="flex items-center text-textmuted"
                                href="javascript:void(0);">Widgets 
                            </a> </li>
                        </ol>
                        </nav>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xxl:col-span-5 xl:col-span-12 lg:col-span-12 col-span-12">
                            <div class="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow">
                                                    <div
                                                        class="flex flex-wrap items-center justify-between text-[.875rem] mb-1">
                                                        <span class="flex-grow">Bitcoin</span>
                                                        <span class="ms-1 text-textmuted">BTC</span>
                                                    </div>
                                                    <div class="flex flex-wrap items-center justify-between">
                                                        <h5 class="font-semibold mb-0">$12,800</h5>
                                                        <div class="flex-grow">
                                                            <span
                                                                class="ms-2 badge bg-success/10 text-success rounded-full">+25.8%</span>
                                                        </div>
                                                        <div id="btcCoin"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow">
                                                    <div
                                                        ...
                                                        <span class="ms-1 text-textmuted">ETH</span>
                                                    </div>
                                                    <div class="flex flex-wrap items-center justify-between">
                                                        <h5 class="font-semibold mb-0">$18,600</h5>
                                                        <div class="flex-grow">
                                                            <span
                                                                class="ms-2 badge bg-success/10 text-success rounded-full">+12.9%</span>
                                                        </div>
                                                        <div id="ethCoin"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow">
                                                    <div
                                                        ...
                                                        <span class="ms-1 text-textmuted">DSH</span>
                                                    </div>
                                                    <div class="flex flex-wrap items-center justify-between">
                                                        <h5 class="font-semibold mb-0">$16,580</h5>
                                                        <div class="flex-grow">
                                                            <span
                                                                class="ms-2 badge bg-success/10 text-success rounded-full">+15.7%</span>
                                                        </div>
                                                        <div id="dshCoin"></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex-grow">
                                                    <div
                                                        ...
                                                        <span class="ms-1 text-textmuted">GLM</span>
                                                    </div>
                                                    <div class="flex flex-wrap items-center justify-between">
                                                        <h5 class="font-semibold mb-0">$12,545</h5>
                                                        <div class="flex-grow">
                                                            <span
                                                                class="ms-2 badge bg-success/10 text-success rounded-full">+12.1%</span>
                                                        </div>
                                                        <div id="glmCoin"></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex items-center mb-4">
                                                <div class="flex-grow flex items-center">
                                                    <div class="me-2"> <span
                                                            class="avatar rounded-[0.375rem] !bg-primary !text-white text-[1.25rem]"><i
                                                                class="bi bi-people"></i></span> </div>
                                                    <div class="flex-grow">
                                                        <p class="mb-0 font-medium text-[1rem] ">Premium Recruiters</p><span
                                                            class="text-success text-[0.75rem]">7 New</span>
                                                    </div>
                                                </div>
                                                <div> <a href="javascript:void(0);"
                                                        class="ti-btn ti-btn-icon ti-btn-primary !rounded-full btn-wave mb-0"
                                                        aria-label="View All"><i
                                                            class="bi bi-chevron-right rtl:rotate-180"></i></a> </div>
                                            </div>
                                            <p class="mb-3 text-[1.25rem] font-semibold">386</p>
                                            <p class="mb-4 text-textmuted font-normal">Recents</p>
                                            <div class="flex items-center justify-between">
                                                <div class="flex -space-x-2 items-center"> <a href="javascript:void(0);"
                                                        class="avatar avatar-sm rounded-circle overflow-hidden"
                                                        aria-label="Mis x matched"><img src="{{asset('build/assets/images/faces/2.jpg')}}"
                                                            alt="img" class="w-full"></a> <a href="javascript:void(0);"
                                                        class="avatar avatar-sm rounded-circle overflow-hidden"
                                                        aria-label="Barbel Bob"><img src="{{asset('build/assets/images/faces/12.jpg')}}"
                                                            alt="img" class="w-full"></a> <a href="javascript:void(0);"
                                                        class="avatar avatar-sm rounded-circle overflow-hidden"
                                                        aria-label="Phan Rel"><img src="{{asset('build/assets/images/faces/20.jpg')}}"
                                                            alt="img" class="w-full"></a> <a href="javascript:void(0);"
                                                        class="avatar avatar-sm rounded-circle overflow-hidden bg-primary text-white">+4</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex items-center">
                                                <div class="flex-grow">
                                                    ...
                                                    <p class="mb-0 text-textmuted">Active Members</p>
                                                </div>
                                                <div class="ms-2"> <span
                                                        class="avatar !bg-info !text-white !rounded-full text-[1.25rem]"><i
                                        ...
                                        <div class="box-body">
                                            <div class="flex items-center">
                                                <div class="flex-grow">
                                                    ...
                                                    <p class="mb-0 text-textmuted">Registrations</p>
                                                </div>
                                                <div class="ms-2"> <span
                                                        class="avatar !bg-success !text-white !rounded-full text-[1.25rem]"><i
                                                            class="bi bi-file-earmark-text"></i></span> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="xxl:col-span-2 xl:col-span-12 lg:col-span-12 col-span-12">
                            <div class="">
                                <div class="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="flex flex-wrap items-start justify-between ">
                                                <div class="flex-grow">
                                                    <p class="mb-1 text-textmuted">Total Candidates</p>
                                                    <div class="flex items-center">
                                                        <span class="text-[1.25rem] font-semibold">9,231</span>
                                                        <span class="text-[0.75rem] text-success ms-2"><i
                                                                class="ti ti-trending-up me-1 inline-block"></i>0.5%</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span
                                                        class="avatar avatar-md !rounded-full bg-primary/10 !text-primary text-[1.125rem]">
                                ...
                                <div class="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="flex flex-wrap items-start justify-between">
                                                <div class="flex-grow">
                                                    <p class="mb-1 text-textmuted">Total Subscriptions
                                                    </p>
                                                    <div class="flex items-center">
                                                        <span class="text-[1.25rem] font-semibold">3,571</span>
                                                        <span class="text-[0.75rem] !text-success ms-2"><i
                                                                class="ti ti-trending-up me-1 inline-block !text-success"></i>0.42%</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span
                                                        class="avatar avatar-md !rounded-full bg-secondary/10 !text-secondary text-[1.125rem]">
                                ...
                                <div class="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="flex flex-wrap items-start justify-between">
                                                <div class="flex-grow">
                                                    <p class="mb-1 text-textmuted">Page Views</p>
                                                    <div class="flex items-center">
                                                        <span class="text-[1.25rem] font-semibold">1,986</span>
                                                        <span class="text-[0.75rem] text-success ms-2"><i
                                                                class="ti ti-trending-up me-1 inline-block"></i>5.1%</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span
                                                        class="avatar avatar-md !rounded-full bg-success/10 !text-success text-[1.125rem]">
                                ...
                                <div class="xxl:col-span-12 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="flex flex-wrap items-start justify-between">
                                                <div class="flex-grow">
                                                    <p class="mb-1 text-textmuted">New Registrations</p>
                                                    <div class="flex items-center">
                                                        <span class="text-[1.25rem] font-semibold">773</span>
                                                        <span class="text-[0.75rem] text-success ms-2"><i
                                                                class="ti ti-trending-up me-1 inline-block"></i>3.5%</span>
                                                    </div>
                                                </div>
                                                <div>
                                                    <span
                                                        class="avatar avatar-md !rounded-full bg-info/10 !text-info text-[1.125rem]">
                                    ...
                                    <div class="box custom-box">
                                        <div class="box-body">
                                            <div class="flex items-center mb-4"> <span
                                                    class="avatar avatar-md !rounded-full bg-primary me-2"> <i
                                                        class="bi bi-people text-[1rem]"></i> </span>
                                                <p class="mb-0 flex-grow text-[1rem] font-medium">Active Members
                                                </p>
                                            </div> <span class="text-[1.25rem] font-semibold">$12,897</span> <span
                                                class="text-[0.75rem] text-success ms-1"><i
                                                    class="ti ti-trending-up me-1 inline-block"></i>3.5%</span>
                                            <div class="font-normal flex items-center mb-2 mt-3">
                                                <p class="mb-0 flex-grow font-medium">Active Candidates</p><span>3,274</span>
                                            </div>
                                            <div class="progress progress-xs">
                                                <div class="progress-bar !bg-primary w-1/4" aria-valuenow="25"
                                        ...
                                        <div class="box-body">
                                            <div class="flex items-center">
                                                <div class="flex-grow">
                                                    <p class="mb-1 text-[1.25rem] font-semibold text-default">1,773</p>
                                                    <p class="mb-0 text-textmuted">Active Members</p>
                                                    <p class="mb-0 text-[.6875rem]"><a href="javascript:void(0);"
                                                            class="text-success underline">View All</a></p>
                                                </div>
                                                <div class="ms-2">
                                                    <span
                                                        class="avatar !bg-info !text-white !rounded-full text-[1.25rem]"><i
                        ...
                        <div class="xxl:col-span-2 xl:col-span-6 lg:col-span-12 col-span-12">
                            <div class="">
                                <div class="xl:col-span-12 col-span-12">
                                    <div class="box custom-box box-bg-primary">
                                        <div class="box-header pb-4 !bg-white/20 !border-b-0 flex justify-between">
                                            <div class="box-title !text-white before:hidden">
                                                Premium Recruiters
                                            </div>
                                            <div>
                                                <button aria-label="button" type="button"
                                                    class="ti-btn ti-btn-sm !bg-primary !mb-0"><i
                                                        class="ti ti-chevron-right rtl:rotate-180"></i></button>
                                            </div>
                                        </div>
                                        <div class="box-body">
                                            <div class="flex flex-wrap items-start">
                                                <div class="flex-grow overflow-hidden">
                                                    <p class="mb-2 leading-none text-[1.25rem] font-semibold !text-white">
                                                        9,231</p>
                                                    <p class="mb-0 text-[0.75rem] text-white opacity-[0.7]">
                                                        <span class="!text-white"><i
                                                                class="bi bi-caret-up-fill !text-white"></i> 2.3%</span>
                                                        <span class="opacity-[0.7] ms-1 !text-white">From Last Month</span>
                                                    </p>
                                                </div>
                                                <div>
                                                    <span class="avatar avatar-sm bg-success !rounded-full"><i
                                                            class="bi bi-people-fill"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="p-4">
                                                <div class="flex flex-wrap mb-1">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="pe-2">
                                                        <span
                                                            class="avatar border text-textmuted !text-primary dark:border-defaultborder/10"><i
                                                                class="ri-apple-fill text-[1.125rem]"></i></span>
                                                    </a>
                                                    <div class="flex-grow">
                                                        <div class="flex flex-wrap items-center justify-between mb-1">
                                                            ...
                                                            <span class="!text-success text-end"><i
                                                                    class="ti ti-trending-up text-[.6875rem] me-1 inline-block"></i>0.14%</span>
                                                        </div>
                                                        <div
                                                            class="flex flex-wrap items-center justify-between text-[0.75rem] mb-4">
                                                            <span class="text-textmuted">$12,289.44</span>
                                                ...
                                                <div class="flex items-center">
                                                    <a href="javascript:void(0);"
                                                        class="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-light me-2">Short</a>
                                                    <a href="javascript:void(0);"
                                                        class="flex-grow ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary">Buy</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="p-4">
                                                <div class="flex flex-wrap mb-1">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="pe-2">
                                                        <span
                                                            class="avatar border text-textmuted !text-primary dark:border-defaultborder/10"><i
                                                                class="ri-bit-coin-fill text-[1.125rem]"></i></span>
                                                    </a>
                                                    <div class="flex-grow">
                                                        <div class="flex flex-wrap items-center justify-between mb-1">
                                                            <span class="font-semibold">Bitcoin</span>
                                                            <span class="text-success text-end"><i
                                                                    class="ti ti-trending-up text-[.6875rem] me-1 inline-block"></i>2.14%</span>
                                                        </div>
                                                        <div
                                                            class="flex flex-wrap items-center justify-between text-[0.75rem] mb-3">
                                                            <span class="text-textmuted">$58,151.02</span>
                                ...
                                <div class="box-body">
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="flex-grow flex items-start">
                                            <div class="me-2">
                                                <span
                                                    class="avatar avatar-md !text-primary border bg-light dark:border-defaultborder/10"><i
                                                        class="ti ti-users text-[1.125rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                                <p class="font-semibold text-[.875rem] mb-0">Total Candidates</p>
                                                <p class="mb-0 text-textmuted text-[0.75rem] opacity-[0.7]">
                                                    Magna sit elitr kasd consetetur.</p>
                                            </div>
                                        </div>
                                        <div class="hs-dropdown ti-dropdown">
                                            ...
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                                                ...
                                                <li><a href="javascript:void(0);" class="ti-dropdown-item">Another
                                                        Action</a></li>
                                                <li><a href="javascript:void(0);" class="ti-dropdown-item">Something Else
                                                        Here</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="flex items-center mb-0">
                                        ...
                                        <span class="text-textmuted ms-2"><i
                                                class="ti ti-trending-up align-middle text-success me-1 inline-block"></i>2.5%</span>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex-grow">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar bg-primary w-[14%]" aria-valuenow="15"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="ms-3">
                                            <span class="text-[0.75rem] text-textmuted">14% Target</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box-body">
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="flex-grow flex items-start">
                                            <div class="me-2">
                                                <span
                                                    class="avatar avatar-md !text-secondary border bg-light dark:border-defaultborder/10"><i
                                                        class="ti ti-user-circle text-[1.125rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                                <p class="font-semibold text-[.875rem] mb-0">Recruiters</p>
                                                <p class="mb-0 text-textmuted text-[0.75rem] opacity-[0.7]">
                                                    Elitr at gubergr sed.</p>
                                            </div>
                                        </div>
                                        <div class="hs-dropdown ti-dropdown">
                                            <a aria-label="anchor" href="javascript:void(0);"
                                    ...
                                    <div class="flex items-center mb-0">
                                        ...
                                        <span class="text-textmuted ms-2"><i
                                                class="ti ti-trending-up align-middle text-success me-1 inline-block"></i>3.1%</span>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex-grow">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar !bg-secondary w-[55%]" aria-valuenow="55"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="ms-3">
                                            <span class="text-[0.75rem] text-textmuted">55% Target</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box-body">
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="flex-grow flex items-start">
                                            <div class="me-2">
                                                <span
                                                    class="avatar avatar-md !text-success border bg-light dark:border-defaultborder/10"><i
                                                        class="ti ti-view-360 text-[1.125rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                                <p class="font-semibold text-[.875rem] mb-0">Page Views</p>
                                                <p class="mb-0 text-textmuted text-[0.75rem] opacity-[0.7]">
                                                    Sed duo ut sanctus gubergren.</p>
                                            </div>
                                        </div>
                                        <div class="hs-dropdown ti-dropdown">
                                            <a aria-label="anchor" href="javascript:void(0);"
                                    ...
                                    <div class="flex items-center mb-0">
                                        ...
                                        <span class="text-textmuted ms-2"><i
                                                class="ti ti-trending-up align-middle text-success me-1 inline-block"></i>5.4%</span>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex-grow">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar !bg-success w-[24%]" aria-valuenow="24"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="ms-3">
                                            <span class="text-[0.75rem] text-textmuted">24% Target</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box-body">
                                    <div class="flex items-start justify-between mb-6">
                                        <div class="flex-grow flex items-start">
                                            <div class="me-2">
                                                <span
                                                    class="avatar avatar-md !text-indigomain border bg-light dark:border-defaultborder/10"><i
                                                        class="ti ti-view-360 text-[1.125rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                                <p class="font-semibold text-[.875rem] mb-0">Total Subscriptions</p>
                                                <p class="mb-0 text-textmuted text-[0.75rem] opacity-[0.7]">
                                                    Invidunt magna voluptua.</p>
                                            </div>
                                        </div>
                                        <div class="hs-dropdown ti-dropdown">
                                            <a aria-label="anchor" href="javascript:void(0);"
                                    ...
                                    <div class="flex items-center mb-0">
                                        ...
                                        <span class="text-textmuted ms-2"><i
                                                class="ti ti-trending-down align-middle text-danger me-1 inline-block"></i>3.2%</span>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex-grow">
                                            <div class="progress progress-xs">
                                                <div class="progress-bar !bg-indigo w-[67%]" aria-valuenow="67"
                                                    aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="ms-3">
                                            <span class="text-[0.75rem] text-textmuted">67% Target</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="xl:col-span-9 col-span-12">
                            <div class="box custom-box">
                                <div class="box-body !p-0">
                                    <div class="grid grid-cols-12 gap-x-6">
                                        <div
                                            class="xl:col-span-3 col-span-12 border-e border-dashed dark:border-defaultborder/10">
                                            <div class="flex flex-wrap items-start p-6">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <p class="text-textmuted mb-0 text-[0.75rem]">Total
                                                        Products</p>
                                                </div>
                                                <div>
                                                    <span class="badge bg-success/10 text-success"><i
                                                            class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>1.31%</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <div class="flex flex-wrap items-start p-6">
                                                ...
                                                <div>
                                                    <span class="badge bg-danger/10 text-danger"><i
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-wrap items-start p-6">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <p class="text-textmuted mb-0 text-[0.75rem]">Income
                                                    </p>
                                                </div>
                                                <div>
                                                    <span class="badge bg-success/10 text-success"><i
                                                            class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>2.58%</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="xl:col-span-3 col-span-12 ">
                                            <div class="flex flex-wrap items-start p-6">
                                                ...
                                                <div>
                                                    <span class="badge bg-success/10 text-success"><i
                                                            class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>12.05%</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box custom-box box-bg-primary text-white">
                                <div class="box-body !p-0">
                                    <div class="flex items-start p-6 flex-wrap">
                                        <div class="me-4 leading-none">
                                            <span
                                                class="avatar avatar-md !rounded-full bg-white dark:bg-bodybg !text-primary shadow-sm">
                                        ...
                                        <div>
                                            <span class="badge bg-success text-white"><i
                                                    class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>14.69%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="xxl:col-span-6 xl:col-span-12 col-span-12">
                            <div class="box custom-box">
                                <div class="box-header flex justify-between">
                                    ...
                                    <div class="hs-dropdown ti-dropdown">
                                        <a href="javascript:void(0);" class="p-2 text-[0.75rem] text-textmuted">
                                        ...
                                        <table class="table whitespace-nowrap table-bordered min-w-full">
                                            ...
                                            <tbody>
                                                <tr class="border border-defaultborder">
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked flex items-center -space-x-2">
                                                            ...
                                                            <a class="avatar avatar-xs bg-primary !rounded-full text-white"
                                                    ...
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar progress-bar-striped progress-bar-animated w-3/5"
                                                ...
                                                <tr class="border border-defaultborder">
                                                    ...
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar progress-bar-striped progress-bar-animated w-full"
                                                ...
                                                <tr class="border border-defaultborder">
                                                    ...
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar progress-bar-striped progress-bar-animated w-1/2"
                        ...
                        <div class="xxl:col-span-3 xl:col-span-6 col-span-12">
                            <div class="box custom-box">
                                <div class="box-header flex justify-between">
                                    ...
                                    <div>
                                        <button type="button" class="ti-btn !py-1 !px-2 !text-[0.75rem] ti-btn-primary">View
                                            All</button>
                                    </div>
                                </div>
                                <div class="box-body">
                                    <ul class="list-unstyled timeline-widget mb-0 my-3">
                                        <li class="timeline-widget-list mb-[2rem]">
                                            <div class="flex items-start">
                                                <div class="me-[3rem] text-center">
                                                    <span class="block text-[1.25rem] font-semibold">02</span>
                                                    <span class="block text-[0.75rem] text-textmuted">Mon</span>
                                                </div>
                                                <div class="flex flex-wrap flex-grow items-center justify-between">
                                                    <div>
                                                        <p class="mb-1  timeline-widget-content text-wrap">You have
                                                            meating - Diam Eirmod</p>
                                                        <p class="mb-0 text-[0.75rem] leading-none text-textmuted">
                                                            10:00AM<span
                                                                class="badge bg-primary/10 text-primary ms-2">Announcement</span>
                                                        </p>
                                                    </div>
                                                    <div class="hs-dropdown ti-dropdown">
                                                        <a aria-label="anchor" href="javascript:void(0);"
                                                            class="p-2 text-[1rem] text-textmuted">
                                        ...
                                        <li class="timeline-widget-list mb-[2rem]">
                                            <div class="flex items-start">
                                                <div class="me-[3rem] text-center">
                                                    ...
                                                    <span class="block text-[0.75rem] text-textmuted">Sun</span>
                                                </div>
                                                <div class="flex flex-wrap flex-grow items-center justify-between">
                                                    <div>
                                                        <p class="mb-1 sm:text-truncate timeline-widget-content text-wrap">
                                                            National holiday - Vero Jayanti</p>
                                                        <p class="mb-0 text-[0.75rem] leading-none text-textmuted">
                                                            <span class="badge bg-warning/10 text-warning">Holiday</span>
                                                        </p>
                                                    </div>
                                                    <div class="hs-dropdown ti-dropdown">
                                                        <a aria-label="anchor" href="javascript:void(0);"
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex flex-wrap flex-grow items-center justify-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-4 text-[0.75rem] leading-none text-textmuted">
                                                            09:00AM<span
                                                                class="badge bg-success/10 text-success ms-2">Birthday</span>
                                                        </p>
                                                    </div>
                                                    <div class="hs-dropdown ti-dropdown">
                                                        <a aria-label="anchor" href="javascript:void(0);"
                                        ...
                                        <li class="timeline-widget-list mb-[2rem]">
                                            <div class="flex items-start">
                                                ...
                                                <div class="flex flex-wrap flex-grow items-center justify-between">
                                                    <div>
                                                        <p class="mb-1 sm:text-truncate timeline-widget-content text-wrap">
                                                            Amet sed no dolor kasd - Tempor Erat</p>
                                                        <p class="mb-0 text-[0.75rem] leading-none text-textmuted">
                                                            04:00PM<span
                                                                class="badge bg-primary/10 text-primary ms-2">Announcement</span>
                                                        </p>
                                                ...
                                                <div class="flex flex-wrap flex-grow items-center justify-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-0 fs-12 lh-1 text-muted"><span
                                                                class="badge bg-warning/10 !text-warning">Holiday</span></p>
                                                    </div>
                                                    <div class="hs-dropdown ti-dropdown">
                                                        <a aria-label="anchor" href="javascript:void(0);"
                                                            class="p-2 text-[1rem] text-textmuted">
                                        ...
                                        <table class="table table-bordered table-hover whitespace-nowrap min-w-full">
                                            ...
                                            <tbody>
                                                <tr class="border border-defaultborder ">
                                                    ...
                                                    <td>
                                                        <span><i
                                                                class="ri-arrow-up-s-fill me-1 text-success align-middle text-[1.125rem]"></i>23,379</span>
                                                    </td>
                                                    <td>
                                                        <span>16,890</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-primary w-[34%]" aria-valuenow="34"
                                                ...
                                                <tr class="border border-defaultborder ">
                                                    ...
                                                    <td>
                                                        <span><i
                                                                class="ri-arrow-up-s-fill me-1 text-success align-middle text-[1.125rem]"></i>78,973</span>
                                                    </td>
                                                    <td>
                                                        <span>29,906</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-primary w-[58%]" aria-valuenow="58"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="border border-defaultborder ">
                                                    ...
                                                    <td>
                                                        <span><i
                                                                class="ri-arrow-up-s-fill me-1 text-success align-middle text-[1.125rem]"></i>12,457</span>
                                                    </td>
                                                    <td>
                                                        <span>8,674</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-primary w-[62%]" aria-valuenow="62"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="border border-defaultborder ">
                                                    ...
                                                    <td>
                                                        <span><i
                                                                class="ri-arrow-up-s-fill me-1 text-success align-middle text-[1.125rem]"></i>8,570</span>
                                                    </td>
                                                    <td>
                                                        <span>4,980</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-primary w-[71%]" aria-valuenow="71"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="border border-defaultborder ">
                                                    ...
                                                    <td>
                                                        <span><i
                                                                class="ri-arrow-up-s-fill me-1 text-success align-middle text-[1.125rem]"></i>6,135</span>
                                                    </td>
                                                    <td>
                                                        <span>4,436</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-primary w-[48%]" aria-valuenow="48"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr class="border border-defaultborder ">
                                                    ...
                                                    <td>
                                                        <span><i
                                                                class="ri-arrow-up-s-fill me-1 text-success align-middle text-[1.125rem]"></i>4,789</span>
                                                    </td>
                                                    <td>
                                                        <span>2,447</span>
                                                    </td>
                                                    <td>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-primary w-[28%]" aria-valuenow="28"
                                                                aria-valuemin="0" aria-valuemax="100">
                                                            </div>
                                                        </div>
                                                    </td>
                                ...
                                <div class="box-body">
                                    <div class="flex flex-wrap justify-between mb-[3rem]">
                                        <div class="me-[3rem] flex items-center">
                                            <div class="me-2">
                                                <span class="avatar !rounded-full bg-primary/10 !text-primary"><i
                                                        class="ri-user-3-line text-[1rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                                <p class="text-[1.125rem] mb-0 text-primary font-semibold">25,350</p>
                                                <span class="text-textmuted text-[0.75rem]">This
                                                    month</span>
                                            </div>
                                        </div>
                                        <div class="me-4 flex items-center">
                                            <div class="me-2">
                                                <span class="avatar !rounded-full bg-light !text-defaulttextcolor"><i
                                                        class="ri-user-3-line text-[1rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                                <p class="text-[1.125rem] mb-0 font-semibold">19,200</p>
                                                <span class="text-textmuted text-[0.75rem]">Last
                                                    month</span>
                                            </div>
                                        </div>
                                        <div class="me-4 flex items-center">
                                            <div class="me-2">
                                                <span class="avatar !rounded-full bg-success/10 !text-success"><i
                                                        class="ri-user-3-line text-[1rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                        ...
                                        <div class="me-4 flex items-center">
                                            <div class="me-2">
                                                <span class="avatar !rounded-full bg-secondary/10 !text-secondary"><i
                                                        class="ri-user-3-line text-[1rem]"></i></span>
                                            </div>
                                            <div class="flex-grow">
                                            ...
                                            <div class="h-full my-auto">
                                                <ul class="ti-list-group">
                                                    <li class="ti-list-group-item">
                                                        <div class="flex flex-wrap items-center justify-between">
                                                            <div><i
                                                                    class="ri-checkbox-blank-circle-fill text-primary text-[0.5rem] me-1 align-middle inline-block"></i>Brazil
                                                            </div>
                                                            <div>1,290</div>
                                                            <div class="text-success"><i
                                                                    class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>2.90%
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="ti-list-group-item">
                                                        <div class="flex flex-wrap items-center justify-between">
                                                            <div><i
                                                                    class="ri-checkbox-blank-circle-fill text-secondary text-[0.5rem] me-1 align-middle inline-block"></i>Greenland
                                                            </div>
                                                            <div>2,596</div>
                                                            <div class="text-danger"><i
                                                                    class="ri-arrow-down-s-line align-middle me-1 inline-block"></i>1.1%
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="ti-list-group-item">
                                                        <div class="flex flex-wrap items-center justify-between">
                                                            <div><i
                                                                    class="ri-checkbox-blank-circle-fill text-success text-[0.5rem] me-1 align-middle inline-block"></i>Russia
                                                            </div>
                                                            <div>3,710</div>
                                                            <div class="text-success"><i
                                                                    class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>0.8%
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="ti-list-group-item">
                                                        <div class="flex flex-wrap items-center justify-between">
                                                            <div><i
                                                                    class="ri-checkbox-blank-circle-fill text-warning text-[0.5rem] me-1 align-middle inline-block"></i>Palestine
                                                            </div>
                                                            <div>1,116</div>
                                                            <div class="text-danger"><i
                                                                    class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>10.06%
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="ti-list-group-item">
                                                        <div class="flex flex-wrap items-center justify-between">
                                                            <div><i
                                                                    class="ri-checkbox-blank-circle-fill text-danger text-[0.5rem] me-1 align-middle inline-block"></i>Canada
                                                            </div>
                                                            <div>12,150</div>
                                                            <div class="text-success"><i
                                                                    class="ri-arrow-up-s-line align-middle me-1 inline-block"></i>9.05%
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                    ...
                    <!-- Start::row-8 -->
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xxl:col-span-4  xl:col-span-4 md:col-span-12 col-span-12">
                            <div class="box custom-box">
                                <div class="box-header flex justify-between">
                                    <div class="box-title">
                                        Upcoming Events
                                ...
                                <div class="box-body">
                                    <nav class="flex flex-wrap xxxl:flex-nowrap justify-start sm:justify-between"
                                        aria-label="Tabs" role="tablist">
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white active"
                                            id="mon" data-hs-tab="#mon-1" aria-controls="mon-1">
                                            <span class="block mb-1">09</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Mon</span>
                                        </button>
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white"
                                            id="tue" data-hs-tab="#tue-1" aria-controls="tue-1">
                                            <span class="block mb-1">10</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Tue</span>
                                        </button>
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white"
                                            id="wed" data-hs-tab="#wed-1" aria-controls="wed-1">
                                            <span class="block mb-1">11</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Wed</span>
                                        </button>
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white"
                                            id="thu" data-hs-tab="#thu-1" aria-controls="thu-1">
                                            <span class="block mb-1">12</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Thu</span>
                                        </button>
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white"
                                            id="fri" data-hs-tab="#fri-1" aria-controls="fri-1">
                                            <span class="block mb-1">13</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Fri</span>
                                        </button>
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white"
                                            id="sat" data-hs-tab="#sat-1" aria-controls="sat-1">
                                            <span class="block mb-1">14</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Sat</span>
                                        </button>
                                        <button type="button"
                                            class="xxxl:w-full hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-[0.8rem] block items-center gap-2 bg-transparent text-sm font-medium text-center text-defaulttextcolor rounded-sm hover:text-primary  dark:text-textmuted dark:hover:text-white"
                                            id="sun" data-hs-tab="#sun-1" aria-controls="sun-1">
                                            <span class="block mb-1">15</span>
                                            <span class="block mb-0 opacity-[0.7] text-[0.75rem]">Sun</span>
                                        </button>
                                    </nav>
                                    <div class="tab-content pt-4 my-4">
                                        <div id="mon-1" role="tabpanel" aria-labelledby="mon">
                                                ...
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                                            ...
                                                            <p class="mb-0 text-textmuted">Video
                                                                Conference</p>
                                                        </div>
                                                        <div>
                                                            <span class="text-textmuted"><i
                                                                    class="ri-time-line align-middle me-1 inline-block "></i>9:00am
                                                                - 10:00am</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                                            ...
                                                            <p class="mb-0 text-textmuted">Dolores Ait
                                                                Labore Sit</p>
                                                        </div>
                                                        <div>
                                                            <span class="text-textmuted"><i
                                                                    class="ri-time-line align-middle me-1 inline-block"></i>12:00pm
                                                                - 12:45am</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                                            ...
                                                            <p class="mb-0 text-textmuted">Golden PArk
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <span class="text-textmuted"><i
                                                                    class="ri-time-line align-middle me-1 inline-block"></i>4:00pm
                                                                - 5:30pm</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                                            ...
                                                            <p class="mb-0 text-textmuted">2UA Project
                                                            </p>
                                                        </div>
                                                        <div>
                                                            <span class="text-textmuted"><i
                                                                    class="ri-time-line align-middle me-1 inline-block"></i>5:00pm
                                                                - 5:45pm</span>
                                                        </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div id="tue-1" class="hidden" role="tabpanel" aria-labelledby="tue">
                                            <ul class="list-unstyled mb-0 upcoming-events-list">
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                        ...
                                        <div id="wed-1" class="hidden" role="tabpanel" aria-labelledby="wed">
                                            <ul class="list-unstyled mb-0 upcoming-events-list">
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                        ...
                                        <div id="thu-1" class="hidden" role="tabpanel" aria-labelledby="thu">
                                            <ul class="list-unstyled mb-0 upcoming-events-list">
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                        ...
                                        <div id="fri-1" class="hidden" role="tabpanel" aria-labelledby="fri">
                                            <ul class="list-unstyled mb-0 upcoming-events-list">
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                        ...
                                        <div id="sat-1" class="hidden" role="tabpanel" aria-labelledby="sat">
                                            <ul class="list-unstyled mb-0 upcoming-events-list">
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                                        ...
                                        <div id="sun-1" class="hidden" role="tabpanel" aria-labelledby="sun">
                                            <ul class="list-unstyled mb-0 upcoming-events-list">
                                                <li>
                                                    <div class="flex items-start justify-conent-between">
                                                        <div class="flex-grow">
                        ...
                        <div class="xxl:col-span-4 xl:col-span-4  md:col-span-12 col-span-12">
                            <div class="box">
                                <div class="box-header flex justify-between">
                                    ...
                                    <div class="hs-dropdown ti-dropdown block ms-auto">
                                        <button type="button"
                                            class="hs-dropdown-toggle px-2 py-1 ti-btn ti-btn-primary">Sort By<i
                                ...
                                <div class="box-body pb-4">
                                    <div class="mb-6">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="float-end text-primary"
                                        ...
                                        <h4 class="mb-2 font-medium">$54,125.03</h4>
                                        <span class="text-danger me-1 text-sm"> - 1.3%<i
                                                class="ri-arrow-down-s-fill align-middle"></i> </span>
