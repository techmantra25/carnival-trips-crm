...
@section('content')
                    ...
                    <div class="my-auto">
                        <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Cards</h5>
                        <nav>
                        ...
                        <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <p class="card-text text-textmuted mb-4">when an unknown printer took a galley of type
                        ...
                        <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <p class="card-subtitle mb-4 text-textmuted">Card subtitle</p>
                        ...
                        <div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                            <div class="box">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li
                                        class="list-group-item py-3 px-4 !border-t !border-b !border-defaultborder dark:!border-defaultborder/10 !border-s-0 !border-e-0">
                                        An item</li>
                                    <li
                                        class="list-group-item py-3 px-4 !border-b !border-defaultborder dark:!border-defaultborder/10  !border-s-0 !border-e-0">
                                        A second item</li>
                                </ul>
                                <div class="box-body">
                    ...
                    <div class="grid grid-cols-12 md:gap-6">
                        <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-12 col-span-12">
                            <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Using Grid Markups:</h6>
                        ...
                        <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-12 col-span-12">
                            <div class="grid grid-cols-12 gap-x-6">
                                <h6 class="!text-[1rem] !text-defaulttextcolor dark:text-defaulttextcolor/70 !font-medium mb-4">Quote:</h6>
                                ...
                                <div class="xl:col-span-12 col-span-12">
                                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">List Group:</h6>
                                    <div class="grid grid-cols-12 gap-x-6">
                                        <div
                                            ...
                                            <div class="box">
                                                <ul class="list-group list-group-flush">
                                                    <li
                                                        class="list-group-item py-3 px-4 !border-b !border-defaultborder dark:!border-defaultborder/10  !border-t-0 !border-s-0 !border-e-0">
                                                        An item</li>
                                                    <li
                                                        class="list-group-item py-3 px-4 !border-b !border-defaultborder dark:!border-defaultborder/10 !border-s-0 !border-e-0">
                                                        A second item</li>
                                                    <li class="list-group-item py-3 px-4 !border-s-0 !border-e-0">A third
                                                        item</li>
                                                    <li
                                                        class="list-group-item  py-3 px-4 !border-s-0 !border-e-0 !border-b-0 !border-t !border-defaultborder dark:!border-defaultborder/10">
                                                        A fourth item</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div
                                            ...
                                            <div class="box">
                                                <div
                                                    class="list-group-item py-3 px-4 !border-s-0 !border-e-0 !border-t-0 !border-b !border-defaultborder dark:!border-defaultborder/10">
                                                    Featured
                                                </div>
                                                <ul class="list-group list-group-flush ">
                                                    <li
                                                        class="list-group-item py-3 px-4 !border-0 !border-b !border-defaultborder dark:!border-defaultborder/10">
                                                        An item</li>
                                                    <li class="list-group-item py-3 px-4 !border-s-0 !border-e-0">A second
                                                        item</li>
                                                    <li
                                                        class="list-group-item py-3 px-4 !border-s-0 !border-e-0 !border-b-0 !border-t !border-defaultborder dark:!border-defaultborder/10">
                                                        A third item</li>
                                            ...
                                            <div class="box">
                                                <ul class="list-group list-group-flush">
                                                    <li
                                                        ...
                                                        An item</li>
                                                    <li
                                                        class="list-group-item py-3 px-4 !border-defaultborder dark:!border-defaultborder/10 !border-b !border-s-0 !border-e-0">
                                                        A second item</li>
                                                    <li class="list-group-item py-3 px-4 !border-0">A third item</li>
                                                </ul>
                                                <div class="box-footer !py-[0.65rem] !px-[1.25rem]">
                                                    Card footer
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="grid grid-cols-12 xl:gap-6">
                        <div class="xl:col-span-9 col-span-12">
                            <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Text Alignment:</h6>
                            <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="xl:col-span-3 col-span-12">
                            <h4 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Mixins utilities:</h4>
                            <div class="box border !border-success mb-4">
                                <div class="!py-3 !px-3 bg/10 border-b !text-start !border-success">Header</div>
                                <div class="box-body text-success">
                                    <h6 class="box-title font-semibold !mb-2">Looking For Success?</h6>
                                    <p class="card-text !text-success">If you are going to use a passage of Lorem Ipsum, you
                                        need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                                </div>
                                <div class="!py-3 !px-3 bg/10 border-t border-success">Footer</div>
                            </div>
                        </div>
                    </div>
                    <!-- End::row-3-->
                    ...
                    <!-- Start::row-4 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Card Header &amp; Footer:</h6>
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xl:col-span-3 col-span-12">
                            <div class="box">
                                <div class="box-header !mb-3">
                                    <div class="flex align-center w-full">
                                        ...
                                        <div class="my-auto">
                                            ...
                                            <p class="mb-0 text-textmuted text-[.6875rem]">28 Years, Male</p>
                                        </div>
                                ...
                                <div class="box-body">
                                    ...
                                    the middle of text. All the Lorem Ipsum generators.Lorem Ipsum is therefore always free.
                                    .
                                </div>
                                <div class="box-footer">
                            ...
                            <div class="box">
                                <div class="box-header !border-b-0 !pb-0 !justify-start">
                                    <div>
                                        ...
                                        <p class="block text-textmuted mb-0 text-[.75rem] font-semibold">1 year ago</p>
                                    </div>
                                </div>
                        ...
                        <div class="xl:col-span-3 col-span-12">
                            <div class="box text-center">
                                <div class="box-header !border-b-0 pb-0">
                                    <span class="ms-auto !shadow-none float-end text-[1.0625rem]"><i
                                            class="ri-heart-fill text-danger"></i></span>
                                </div>
                                <div class="box-body !pt-1">
                                    <span class="avatar avatar-xl avatar-rounded me-2 mb-3">
                                        <img src="{{asset('build/assets/images/faces/5.jpg')}}" alt="img">
                                    </span>
                                    <div class="font-semibold text-[1rem]">Sasha Max</div>
                                    <p class="mb-5 text-textmuted text-[.75rem]">Web Developer</p>
                                    <div class="ti-btn-list">
                                        <button type="button" aria-label="button"
                                            class="!me-2 ti-btn ti-btn-icon ti-btn-facebook btn-wave">
                                            <i class="ri-facebook-line"></i>
                                        </button>
                                        <button type="button" aria-label="button"
                                            class="!me-2 ti-btn ti-btn-icon ti-btn-twitter btn-wave">
                        ...
                        <div class="xl:col-span-3 col-span-12">
                            <div class="box text-center">
                                ...
                                <div class="box-footer !text-textmuted">
                                    11.32pm
                                </div>
                            </div>
                        </div>
                        <div class="xl:col-span-3 col-span-12">
                            <div class="box">
                                <div class="box-header">
                                    <div class="flex w-full">
                                        ...
                                        <div class="flex align-center justify-between w-full flex-wrap">
                                            <div class="me-4">
                                                <p class="text-textmuted mb-0">Posts</p>
                                                <p class="font-semibold text-[1rem] mb-0">25</p>
                                            </div>
                                            <div class="me-4">
                                                <p class="text-textmuted mb-0">Followers</p>
                                                <p class="font-semibold text-[1rem] mb-0">1253</p>
                                            </div>
                                            <div class="me-4">
                                                <p class="text-textmuted mb-0">Following</p>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="text-textmuted text-[.6875rem] mb-6">Angular Developer</div>
                        ...
                        <div class="xl:col-span-2 sm:col-span-4 col-span-12">
                            <div class="box">
                                <div class="box-body">
                                    <img src="{{asset('build/assets/images/media/media-5.jpg')}}" class="card-img mb-4 !rounded-md"
                                        alt="...">
                        ...
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box">
                                ...
                                <div id="hs-basic-collapse-heading" class="hs-collapse open w-full  overflow-hidden  transition-[height] duration-100" aria-labelledby="hs-basic-collapse">
                                    ...
                                    <div class="box-footer"> <button type="button" class="ti-btn ti-btn-primary-full">Read More</button> </div>
                                </div>
                            </div>
                        </div>
                        <div class="xl:col-span-4 col-span-12">
                    ...
                    <div class="grid grid-cols-12 md:gap-x-6">
                        <div class="xxl:col-span-6 xl:col-span-12 col-span-12">
                            <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Using Utilities:</h6>
                        ...
                        <div class="xxl:col-span-6 xl:col-span-12 col-span-12">
                            <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Navigation:</h6>
                            <div class="grid grid-cols-12 gap-6">
                                <div class="xl:col-span-6 col-span-12">
                                    <div class="box text-center">
                    ...
                    <!-- Start::row-6 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Image Caps:</h6>
                    <div class="grid grid-cols-12 md:gap-6">
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <p class="card-text mb-4 text-textmuted">But I must explain to you how all this mistaken
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <h6 class="box-title font-semibold mb-1 !text-[1rem]">Image caps are widely used in
                                        Blog's</h6>
                                    <p class="card-text mb-1 text-textmuted">This is a wider card with supporting text below
                                        as
                    ...
                    <!-- Start::row-7 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Image Overlays:</h6>
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box  overlay-card">
                                ...
                                <div class="card-img-overlay flex flex-col p-0">
                                    ...
                                    <div class="box-body overflow-y-scroll text-white">
                        ...
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box overlay-card">
                                ...
                                <div class="card-img-overlay flex flex-col p-0 over-content-bottom">
                                    <div class="box-body  overflow-y-scroll text-white">
                        ...
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box  overlay-card">
                                ...
                                <div class="card-img-overlay flex flex-col p-0">
                                    ...
                                    <div class="box-body overflow-y-scroll flex-grow text-white">
                    ...
                    <!-- Start::row-8 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Horizontal Cards:</h6>
                    <div class="grid grid-cols-12 gap-6">
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box">
                                <div class="grid grid-cols-12 gap-0">
                                    ...
                                    <div class="md:col-span-8 col-span-12">
                                        ...
                                        <div class="box-footer">
                                            <p class="card-text"><small class="text-textmuted">Last updated 3 mins
                                                    ago</small></p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Start::row-9 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Background Colored Cards:</h6>
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xl:col-span-3 col-span-12">
                                ...
                                <div class="box-body">
                                    <div class="flex align-center w-full">
                                        ...
                                        <div class="">
                                            ...
                                            <p class="mb-0 text-textmuted opacity-[0.7] text-[.75rem]">Finished by 24,Nov
                                            </p>
                                        </div>
                                        <div class="ms-auto">
                    ...
                    <!-- Start::row-10 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Colored Border Cards:</h6>
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xl:col-span-3 col-span-12">
                    ...
                    <!-- Start::row-11 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Cards With Link:</h6>
                    <div class="grid grid-cols-12 gap-6">
                                        ...
                                        <div class="box-body">
                                            <div class="flex align-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="box-title !text-textmuted !text-[.75rem] mb-0">Correspondent
                                                        Professor</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            <div class="flex align-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class=" text-textmuted text-[.6875rem] mb-0">24 Years, Female</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- Start::row-12 -->
                    <h6 class="mb-4 !text-defaulttextcolor dark:text-defaulttextcolor/70 !text-[1rem] !font-medium">Grid Cards:</h6>
                    ...
                    <h6 class="text-base !text-defaulttextcolor dark:text-defaulttextcolor/70 font-medium mb-4">Panel actions:</h6>
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="xl:col-span-4 col-span-12">
                            <div class="box terms-box" id="dismiss-alert1">
                                <div class="box-header flex justify-between items-center">
                                    <div class="box-title"> Card action</div>
                                    <div class="flex items-center gap-x-1">
                                        <div class="hs-tooltip inline-block">
                                            <button type="button"
                                                ...
                                                <span
                                                    class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 rounded-sm transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded shadow-sm dark:bg-bodybg"
                                                    role="tooltip">
                                                    Refresh
                                                </span>
                                            </button>
                                        ...
                                        <div class="hs-tooltip inline-block">
                                            <button type="button"
                                                class="terms-fullscreen hs-tooltip-toggle size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white/70 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                                <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg"
                                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round">
                                ...
                                <div class="box-body flex-grow">
                                    <p class="mt-2 text-gray-500 dark:text-white/70">
                                        With supporting text below as a natural lead-in to additional content.
                                    </p>
                                    <a class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-primary hover:text-primary/80 disabled:opacity-50 disabled:pointer-events-none dark:text-primary dark:hover:text-primary/80 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="javascript:void(0);">
                                        Card link
                                        <svg class="flex-shrink-0 size-4 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="box-body">
                                    <div class="flex flex-auto flex-col justify-center items-center">
                                        ...
                                        <a class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                            href="javascript:void(0);">
                                            Card link
                                            <svg class="flex-shrink-0 size-4 rtl:rotate-180"
                        ...
                        <div class="xl:col-span-6 col-span-12">
                            <div class="box">
                                ...
                                <div
                                    class="bg-light border-t border-b border-gray-200 text-sm text-gray-800 p-4 dark:bg-gray-900/[.1] dark:border-white/10 dark:text-white">
                                ...
                                <div class="box-body">
                                    ...
                                    <a class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-primary hover:text-primary/80 disabled:opacity-50 disabled:pointer-events-none dark:text-primary dark:hover:text-primary/80 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        href="javascript:void(0);">
                                        Card link
                                        <svg class="flex-shrink-0 size-4 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="m9 18 6-6-6-6" />
                                        </svg>
                        ...
                        <div class="xl:col-span-6 col-span-12">
                            <div class="box overflow-hidden">
                                <div
                                    class="box-body h-60 overflow-y-auto [&amp;::-webkit-scrollbar]:w-2 [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-track]:bg-gray-100 [&amp;::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&amp;::-webkit-scrollbar-track]:bg-slate-700 dark:[&amp;::-webkit-scrollbar-thumb]:bg-slate-500">
                                    <h3 class="text-lg font-bold text-gray-800 dark:text-white">
                                        Card title
                                    </h3>
                                    <p class="mt-2 text-gray-500 dark:text-white/70">
                                        This is a longer card with supporting text below as a natural lead-in to additional
                                        content. This content is a little bit longer. This is a longer card with supporting
                                        text below as a natural lead-in to additional content. This content is a little bit
                                        longer. This is a longer card with supporting text below as a natural lead-in to
                                        additional content. This content is a little bit longer. This is a longer card with
                                        supporting text below as a natural lead-in to additional content. This content is a
                                        little bit longer. This is a longer card with supporting text below as a natural
                                        lead-in to additional content. This content is a little bit longer. This is a longer
                                        card with supporting text below as a natural lead-in to additional content. This
