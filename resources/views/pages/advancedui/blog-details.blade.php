...
@section('content')
                    ...
                    <div class="my-auto">
                        <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Blog Details</h5>
                        <nav>
                        <ol class="flex items-center whitespace-nowrap min-w-0">
                            ...
                            <li class="text-[12px]"> <a class="flex items-center text-textmuted"
                                href="javascript:void(0);">Blog Details 
                            </a> </li>
                        </ol>
                        </nav>
                    </div>
                            ...
                            <div class="xl:col-span-8  col-span-12">
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="sm:flex items-center">
                                            <div class="flex items-center flex-grow">
                                                ...
                                                <div>
                                                    <p class="mb-0 font-semibold">Json Taylor - <span class="text-[0.6875rem] text-textmuted font-normal">Tue,25 Dec 2022 - 11:45</span></p>
                                                    <p class="mb-0 text-textmuted"></p>
                                                </div>
                                            </div>
                                    ...
                                    <a href="javascript:void(0);">
                                        <img src="{{asset('build/assets/images/media/media-23.jpg')}}" class="card-img rounded-0 !w-full blog-details-img" alt="...">
                                    </a>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <p class="mb-[3rem] text-textmuted">
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                <div class="box">
                                    <div class="box-body text-center !p-6">
                                        ...
                                        <p class="text-[0.75rem] text-textmuted mb-1"><span>emaileyjackson2134</span>@gmail.com</p>
                                        <p class="text-textmuted mb-0 p-4 pb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution </p>
                                    </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <ul class="ti-list-group !rounded-md">
