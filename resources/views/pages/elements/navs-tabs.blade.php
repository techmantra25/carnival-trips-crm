...
@section('content')
                    ...
                    <div class="my-auto">
                        <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Navs & Tabs</h5>
                        <nav>
                        <ol class="flex items-center whitespace-nowrap min-w-0">
                            ...
                            <li class="text-[12px]"> <a class="flex items-center text-textmuted"
                                href="javascript:void(0);">Navs & Tabs 
                            </a> </li>
                        </ol>
                        </nav>
                    </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="ltr:border-r rtl:border-l border-gray-200 dark:border-white/10">
                                    <nav class="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" role="tablist" data-hs-tabs-vertical="true">
                                    <button type="button" class="hs-tab-active:bg-white ltr:hs-tab-active:border-r-transparent rtl:hs-tab-active:border-l-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent ltr:dark:hs-tab-active:border-r-gray-800 rtl:dark:hs-tab-active:border-l-gray-800 dark:hs-tab-active:text-primary -mr-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  ltr:rounded-l-sm rtl:rounded-r-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300 active" id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1" aria-controls="hs-tab-js-vertical-1">
                                        Tab 1
                                    </button>
                    ...
                    <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <select id="tab-select" class="mb-5 sm:hidden py-2 px-3 ltr:pr-9 rtl:pl-9 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bodybg dark:border-white/10 dark:text-white/70" aria-label="Tabs" role="tablist">
                    ...
                    <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <nav class="-mb-0.5 flex space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                    ...
                    <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <nav class="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                    ...
                    <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <nav class="sm:flex sm:space-x-2" aria-label="Tabs" role="tablist">
                    ...
                    <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <a class="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 dark:hs-tab-active:text-defaulttextcolor/70 group relative min-w-0 flex-1 bg-white dark:bg-black py-4 px-4 text-gray-400 text-sm font-medium text-center pointer-events-none overflow-hidden focus:z-10 dark:bg-bodybg dark:text-white/50" href="javascript:void(0);" id="bar-item-4" data-hs-tab="#bar-4">
                                    Disabled
                                </a>
                                </nav>
