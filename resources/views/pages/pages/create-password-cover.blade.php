...
@section('content')
        ...
        <div class="grid grid-cols-12 authentication mx-0">
            ...
            <div class="primary-background  w-full h-full flex items-center justify-center coming-soom-image-container">
                <img src="{{asset('build/assets/images/authentication/10.png')}}" alt="" class="imig-fluid !w-[70%] !h-auto">
            </div>
            </div>
            ...
            <div class="grid grid-cols-12 items-center h-full ">
                ...
                <div class="p-[3rem]">
                    ...
                    <div class="btn-list">
                    <button class="ti-btn ti-btn-lg ti-btn-light !font-medium me-[0.365rem] dark:border-defaultborder/10"><svg
                    ...
                    <div class="xl:col-span-12 col-span-12 mt-0">
                        ...
                        <div class="flex">
                        <input type="password"
                            class="form-control form-control-lg  !w-full !rounded-tl-sm !rounded-bl-sm !rounded-br-none !rounded-tr-none rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm"
                            id="create-password" placeholder="password">
                        <button onclick="createpassword('create-password',this)"
                            class="ti-btn ti-btn-light !mb-0 !rounded-tr-sm !rounded-br-sm !rounded-bl-none !rounded-tl-none rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm !border !border-s-0 !border-defaultborder/10"
                    ...
                    <div class="xl:col-span-12 col-span-12 grid mt-2">
                        <button class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Save
                        Password</button>
                    </div>
                    </div>
