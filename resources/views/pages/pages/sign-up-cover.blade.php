                ...
                <div class="grid grid-cols-12 items-center h-full">
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                        <div class="p-[3rem]">
                            ...
                            <p class="mb-4 text-[#8c9097] opacity-[0.7] font-normal">Welcome & Join us by creating a free account !</p>
                            <div class="btn-list">
                            ...
                            <div class="grid grid-cols-12 gap-y-4">
                                ...
                                <div class="xl:col-span-12 col-span-12">
                                    ...
                                    <div class="input-group">
                                        <input type="password" class="form-control form-control-lg !rounded-tl-sm !rounded-bl-sm rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm" id="signup-password" placeholder="password">
                                        <button class="ti-btn ti-btn-light !rounded-tr-sm !mb-0 !rounded-br-sm rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm !border !border-s-0 !border-defaultborder/10" onclick="createpassword('signup-password',this)" type="button" id="button-addon2"><i class="ri-eye-off-line align-middle"></i></button>
                                    </div>
                                </div>
                                <div class="xl:col-span-12 col-span-12">
                                    <label for="signup-confirmpassword" class="form-label text-default">Confirm Password</label>
                                    <div class="input-group">
                                        <input type="password" class="form-control form-control-lg !rounded-tl-sm !rounded-bl-sm rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm" id="signup-confirmpassword" placeholder="confirm password">
                                        <button class="ti-btn ti-btn-light !mb-0 !rounded-tr-sm !rounded-br-sm rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm !border !border-s-0 !border-defaultborder/10" onclick="createpassword('signup-confirmpassword',this)" type="button" id="button-addon21"><i class="ri-eye-off-line align-middle"></i></button>
                                    </div>
                                    <div class="form-check mt-4 flex items-center gap-2 ">
