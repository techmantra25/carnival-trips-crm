...
@section('content')
        ...
        <div class="grid grid-cols-12 authentication mx-0 text-defaulttextcolor text-defaultsize">
            <div class="xxl:col-span-5 xl:col-span-5 lg:col-span-5 col-span-12 xl:block hidden px-0">
                ...
                <img src="{{asset('build/assets/images/authentication/5.png')}}" alt="" class="imig-fluid">
            </div>
            </div>
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                        <div class="p-[3rem]">
                            ...
                            <div class="btn-list">
                                ...
                                <button class="ti-btn ti-btn-icon ti-btn-primary me-[0.365rem]"><i class="ri-facebook-fill"></i></button>
                                <button class="ti-btn ti-btn-icon ti-btn-info"><i class="ri-twitter-x-line"></i></button>
                            </div>
                            ...
                            <div class="grid grid-cols-12 gap-y-4">
                                ...
                                <div class="xl:col-span-12 col-span-12">
                                    <label for="signin-password" class="form-label text-default block ">Password<a href="{{url('reset-password-cover')}}" class="float-end text-danger">Forget password ?</a></label>
                                    <div class="input-group">
                                        <input type="password" class="form-control form-control-lg !rounded-tl-sm !rounded-bl-sm rtl:!rounded-tl-none rtl:!rounded-bl-none  rtl:!rounded-tr-sm rtl:!rounded-br-sm" id="signin-password" placeholder="password">
                                        <button class="ti-btn ti-btn-light !rounded-tr-sm !mb-0 !rounded-br-sm rtl:!rounded-tr-none rtl:!rounded-br-none  rtl:!rounded-tl-sm rtl:!rounded-bl-sm !border !border-s-0 !border-defaultborder/10" type="button" onclick="createpassword('signin-password',this)" id="button-addon2"><i class="ri-eye-off-line align-middle"></i></button>
                                    </div>
                                    <div class="mt-2">
                                ...
                                <div class="xl:col-span-12 col-span-12 grid mt-0">
                                    <a href="{{url('index')}}" class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Sign In</a>
                                </div>
                            </div>
                            <div class="text-center">
                                <p class="text-[0.75rem] text-[#8c9097] mt-4">Dont have an account? <a href="{{url('sign-up-cover')}}" class="text-primary">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
