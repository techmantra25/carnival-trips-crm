...
@section('content')
                    ...
                    <div class="grid grid-cols-12">
                                ...
                                <div class="box-body border-e border-defaultborder dark:border-defaultborder/10">
                                    <div class="swiper mySwiper2">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img alt="product-image-1" src="{{asset('build/assets/images/ecommerce/13.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-2" src="{{asset('build/assets/images/ecommerce/14.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-3" src="{{asset('build/assets/images/ecommerce/15.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-4" src="{{asset('build/assets/images/ecommerce/16.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-5" src="{{asset('build/assets/images/ecommerce/17.png')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper mySwiper">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <img alt="product-image-1" src="{{asset('build/assets/images/ecommerce/14.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-1" src="{{asset('build/assets/images/ecommerce/15.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-1" src="{{asset('build/assets/images/ecommerce/16.png')}}">
                                            </div>
                                            <div class="swiper-slide">
                                                <img alt="product-image-1" src="{{asset('build/assets/images/ecommerce/17.png')}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box !mb-0 !border-0 !shadow-none">
                                <div class="box-body border-e border-defaultborder dark:border-defaultborder/10">
                                    <div class="p-5 !bg-[#f9fafb] dark:!bg-bodybg">
                                        <div class="space-y-5">
                                            <h5 class="font-bold text-xl text-gray-800 dark:text-white">Blue Shirt</h5>
                                            ...
                                            <p class="text-defaulttextcolor dark:text-white/70"><strong
                                                    class="text-primary">81%</strong> of buyers
                                            ...
                                            <div class="space-y-4">
                                                <h5 class="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    Description :</h5>
                                                <p class="my-auto font-medium text-sm text-defaulttextcolor dark:text-white/70">
                                                    Lorem ipsum dolor sit
                                                    amet, consectetur adipisicing elit. Voluptas sint exercitationem
                                                    veritatis harum maiores
                                                    corporis perspiciatis quos accusantium velit. Deserunt tenetur rerum
                                                    nemo illum. Dolor
                                            ...
                                            <div class="sm:flex sm:space-x-3 product-des">
                                                <h5 class="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    Colors :</h5>
                                                <select class="ti-form-select product-des-select  !w-full !rounded-sm" data-trigger name="product-color-add" id="product-color-add">
                                            ...
                                            <div class="sm:flex sm:space-x-3 product-des">
                                                <h5 class="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    Capacity :</h5>
                                                <select class="ti-form-select product-des-select  !w-full !rounded-sm" data-trigger name="product-des-select" id="product-des-select">
                                            ...
                                            <a href="{{url('wish-list')}}" class="ti-btn ti-btn-ghost-primary"><i
                                            ...
                                            <div class="sm:flex sm:space-x-3 product-des">
                                                <h5 class="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                    Share :</h5>
                                                <div class="flex space-x-1 flex-wrap rtl:space-x-reverse">
                                                    <button aria-label="button" type="button"
                                                        class="m-0 rounded-sm p-2 ti-btn ti-btn-light ring-white/10 text-defaulttextcolor dark:text-white/70 bg-white/10  border-gray-200 dark:border-white/10">
                                                    ...
                                                    <button aria-label="button" type="button"
                                                        class="m-0 rounded-sm p-2 ti-btn ti-btn-light ring-white/10 text-defaulttextcolor dark:text-white/70 bg-white/10  border-gray-200 dark:border-white/10">
                                                        <i class="ri-twitter-x-line text-lg leading-none"></i>
                                                    </button>
                                                    <button aria-label="button" type="button"
                                                        class="m-0 rounded-sm p-2 ti-btn ti-btn-light ring-white/10 text-defaulttextcolor dark:text-white/70 bg-white/10  border-gray-200 dark:border-white/10">
                        ...
                        <div class="col-span-12 xxl:col-span-3">
                            <div class="box !shadow-none !border-0 mb-0 !bg-transparent">
                                <div class="box-body">
                                    <div class="box !shadow-none !border-0 !mb-2">
                                        <div class="box-body !p-0">
                                            <div class="mb-6">
                                                <p class="text-danger mb-3 text-[1rem]">Only 5 left in stock.</p>
                                                <p class="!mb-0 text-[0.75rem]">Sold by <span
                                                        class="text-primary me-1 rtl:ms-1"><u>Regaltos PVT.LTD</u></span>and
                                                    quality checked by <span class="text-primary"><u>Spruko
                                                            Tchnologies</u>.</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box !bg-[#f9fafb] dark:bg-bodybg !shadow-none !bg-transparent">
                                        ...
                                        <div class="box-body space-y-6">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <h5
                                                    ...
                                                    Item :</h5>
                                                <img src="{{asset('build/assets/images/ecommerce/13.png')}}" class="avatar rounded-sm"
                                                    alt="Product-image">
                                            </div>
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <h5
                                                    class="font-normal text-defaulttextcolor dark:text-white/70 text-sm my-auto w-28">
                                                    Color :</h5>
                                                <p class="font-medium text-sm">Blue</p>
                                            </div>
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <h5
                                                    class="font-normal text-defaulttextcolor dark:text-white/70 text-sm my-auto w-28">
                                            ...
                                            <p class="font-medium text-sm">Expected Delivery By Feb 25 ,2024</p>
                                            <div>
                                                <a href="{{url('product-cart')}}" class="w-full ti-btn mb-4 ti-btn-primary-full">Add To Cart</a>
                                                <a href="{{url('check-out')}}"
                                                    class="w-full ti-btn ti-btn-outline ti-btn-outline-primary">Buy
                                                    Now</a>
                                            </div>
                                        </div>
                                    </div>
                                    <p class="text-defaulttextcolor dark:text-white/70 text-sm text-center">Any Issue Reagarding
                                        Product ? <a href="javascript:void(0);" class="text-primary inline-flex"><i
                    ...
                    <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="box">
                                <div class="box-body !pt-0 !px-0">
                                    <div class="border-b border-gray-200 dark:border-white/10">
                                        <nav class="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse px-6" aria-label="Tabs"
                                            role="tablist" data-hs-tabs-vertical="true">
                                            <button aria-label="button" type="button"
                                                class="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-white/70 hover:text-primary active"
                                                id="product-spec-tab-2" data-hs-tab="#product-spec-content-2"
                                                aria-controls="product-spec-content-2" role="tab">
                                                Description
                                            </button>
                                            <button aria-label="button" type="button"
                                                class="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-defaulttextcolor dark:text-white/70 hover:text-primary"
                                    ...
                                    <div class="mt-6 px-6">
                                        <div id="product-spec-content-2" class="" role="tabpanel"
                                            aria-labelledby="product-spec-tab-2">
                                                    ...
                                                    <table class="ti-custom-table ti-custom-table-head">
                                                        <tbody class="!divide-y-0">
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">Dolar</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Connector Type</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">USB</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Battery Capacity</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70"> 2000 mAh</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Special Feature</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">Fast charge
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Weight</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">500grms</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                    ...
                                                    <table class="ti-custom-table ti-custom-table-head">
                                                        <tbody class="!divide-y-0">
                                                            <tr>
                                                                ...
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">6 Months</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Ports</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">Dual Ports</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Dimensions</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">32.25 * 25.2
                                                                    *36.3 cm</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Display</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">Wireless</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="font-bold">Origin</td>
                                                                <td>:</td>
                                                                <td class="text-defaulttextcolor dark:text-white/70">India</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                        ...
                                        <div id="product-spec-content-3" class="hidden" role="tabpanel">
                                            <div class="max-w-lg mx-auto space-y-6">
                                                <div class="space-y-4 text-center">
                                                    ...
                                                    <div><span
                                                            class="text-xl text-warning p-3 bg-warning/20 rounded-full">4.5</span>
                                                    </div>
                                                    <div class="product-rating">
                                                        <i class="ri ri-star-fill text-warning text-xl"></i>
                                                        <i class="ri ri-star-fill text-warning text-xl"></i>
                                                        <i class="ri ri-star-fill text-warning text-xl"></i>
                                                        <i class="ri ri-star-fill text-warning text-xl"></i>
                                                        <i class="ri ri-star-half-fill text-warning text-xl"></i>
                                                    </div>
                                                    <p class="!mt-3 text-sm text-defaulttextcolor dark:text-white/70">Based On
                                                        25,256 Ratings</p>
                                                </div>
                                                <div class="space-y-4">
                                                    <div
                                                        class="flex items-center space-x-5 rtl:space-x-reverse justify-center">
                                                        <div class="text-base flex items-center" leading-none">5<i
                                                                class="ri ri-star-fill text-warning ltr:ml-2 rtl:mr-2"></i>
                                                        </div>
                                                        ...
                                                        <div class="text-defaulttextcolor dark:text-white/70 text-sm">15,252</div>
                                                    </div>
                                                    <div
                                                        class="flex items-center space-x-5 rtl:space-x-reverse justify-center">
                                                        <div class="text-base flex items-center" leading-none">4<i
                                                                class="ri ri-star-fill text-warning ltr:ml-2 rtl:mr-2"></i>
                                                        </div>
                                                        <div class="ti-main-progress h-3 bg-gray-200 dark:bg-black/20">
                                                            <div class="ti-main-progress-bar bg-primary text-xs text-white text-center"
                                                                role="progressbar" style="width: 57%" aria-valuenow="57"
                                                                aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="text-defaulttextcolor dark:text-white/70 text-sm">5,235</div>
                                                    </div>
                                                    <div
                                                        class="flex items-center space-x-5 rtl:space-x-reverse justify-center">
                                                        <div class="text-base flex items-center" leading-none">3<i
                                                                class="ri ri-star-fill text-warning ltr:ml-2 rtl:mr-2"></i>
                                                        </div>
                                                        <div class="ti-main-progress h-3 bg-gray-200 dark:bg-black/20">
                                                            <div class="ti-main-progress-bar bg-primary text-xs text-white text-center"
                                                        ...
                                                        <div class="text-defaulttextcolor dark:text-white/70 text-sm">2,876</div>
                                                    </div>
                                                    <div
                                                        class="flex items-center space-x-5 rtl:space-x-reverse justify-center">
                                                        <div class="text-base flex items-center" leading-none">2<i
                                                                class="ri ri-star-fill text-warning ltr:ml-2 rtl:mr-2"></i>
                                                        </div>
                                                        <div class="ti-main-progress h-3 bg-gray-200 dark:bg-black/20">
                                                            <div class="ti-main-progress-bar bg-primary text-xs text-white text-center"
                                                        ...
                                                        <div class="text-defaulttextcolor dark:text-white/70 text-sm">1,352</div>
                                                    </div>
                                                    <div
                                                        class="flex items-center space-x-5 rtl:space-x-reverse justify-center">
                                                        <div class="text-base flex items-center leading-none">1<i
                                                                class="ri ri-star-fill text-warning ltr:ml-2 rtl:mr-2"></i>
                                                        </div>
                                                        <div class="ti-main-progress h-3 bg-gray-200 dark:bg-black/20">
                                                            <div class="ti-main-progress-bar bg-primary text-xs text-white text-center"
                                                        ...
                                                        <div class="text-defaulttextcolor dark:text-white/70 text-sm">852</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="space-y-2">
                                                <div class="box !shadow-none">
                                                        ...
                                                        <div class="sm:flex justify-between">
                                                            <div class="flex space-x-4 rtl:space-x-reverse">
                                                                <div
                                                                    ...
                                                                    <img class="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full"
                                                                        src="{{asset('build/assets/images/faces/11.jpg')}}" alt="avatar">
                                                                    <div>
                                                                        <p class="font-semibold text-sm">Dolar Paul
                                                                        </p>
                                                                        <p
                                                                            class="flex space-x-2 rtl:space-x-reverse text-defaulttextcolor dark:text-white/70 text-xs font-normal">
                                                                            29 September,2024</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                                                <div class="flex space-x-2 rtl:space-x-reverse">
                                                                    <div class="product-rating">
                                                                        <i
                                                                            class="ri ri-star-fill text-warning text-base leading-none"></i>
                                                                        <i
                                                                            class="ri ri-star-fill text-warning text-base leading-none"></i>
                                                                        <i
                                                                            class="ri ri-star-fill text-warning text-base leading-none"></i>
                                                                        <i
                                                                            class="ri ri-star-fill text-warning text-base leading-none"></i>
                                                                        <i
                                                                            class="ri ri-star-fill text-gray-200 text-base leading-none"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="box-body p-3">
                                                        <h5 class="font-semibold text-slate-700 dark:text-white">Lorem ipsum
                                                            dolor sit amet
                                                            consectetur adipisicing elit.</h5>
                                                        <p class="my-2 text-defaulttextcolor dark:text-white/70 text-xs">Very nice !
                                                            On the other hand,
                                                            we
                                                            denounce with righteous indignation and dislike men who are so
                                                            beguiled and
                                                            demoralized.</p>
                                                        <img src="{{asset('build/assets/images/ecommerce/17.png')}}"
                                                            class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                            alt="Product-image">
                                                        <img src="{{asset('build/assets/images/ecommerce/13.png')}}"
                                                            class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                            alt="Product-image">
                                                        <img src="{{asset('build/assets/images/ecommerce/14.png')}}"
                                                            class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                            alt="Product-image">
                                                    </div>
                                                    <div class="box-footer p-3 flex">
                                                        ...
                                                        <a class="reply ltr:ml-auto rtl:mr-auto"
                                                        ...
                                                        <div class="sm:flex justify-between">
                                                            <div class="flex space-x-4 rtl:space-x-reverse">
                                                                <div
                                                                    class="flex items-center space-x-3 rtl:space-x-reverse">
                                                                    <img class="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full"
                                                                        src="{{asset('build/assets/images/faces/14.jpg')}}" alt="avatar">
                                                                    <div>
                                                                        <p class="font-semibold text-sm">Socrates Imualte
                                                                        </p>
                                                                        <p
                                                                            class="flex space-x-2 rtl:space-x-reverse text-defaulttextcolor dark:text-white/70 text-xs font-normal">
                                                                            25 September,2024</p>
                                        ...
                                        <div id="product-spec-content-1" class="hidden" role="tabpanel">
                                            You can exchange the product up to 30 days after delivery. Shipping on your
                                            first exchange
                                            for any item is free of charge. If you decide to exchange that item again (i.e.
                                            more than once) you
                                            will
                        ...
                        <div class="col-span-12 xxl:col-span-3">
                            <div class="grid grid-cols-12 gap-x-6 divide-x rtl:divide-x-reverse divide-gray-200 dark:divide-white/10">
                                <div class="col-span-12 xl:col-span-12 lg:col-span-12">
                                    <div class="box">
                                        <div class="box-body">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <svg class="w-[3rem] h-[3rem] my-auto" id="SvgjsSvg1023"
                                                    xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    <defs id="SvgjsDefs1024"></defs>
                                                    <g id="SvgjsG1025"><svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div>
                                                    <span
                                                        class="block text-sm font-semibold dark:text-white max-w-[200px] truncate">Secured
                                                        Payments</span>
                                                    <span class="block text-xs text-gray-600 dark:text-white/70">Make Payments
                                                        easily and
                                                        securily</span>
                                                </div>
                                            </div>
                                ...
                                <div class="col-span-12 xl:col-span-12 lg:col-span-12 !border-0">
                                    <div class="box">
                                        <div class="box-body">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <svg class="w-[3rem] h-[3rem] my-auto" id="SvgjsSvg1014"
                                                    xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    <defs id="SvgjsDefs1015"></defs>
                                                    <g id="SvgjsG1016"><svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <div>
                                                    <span
                                                        class="block text-sm font-semibold dark:text-white max-w-[200px] truncate">High
                                                        Quality
                                                        Products</span>
                                                    <span class="block text-xs text-gray-600 dark:text-white/70">Product is Made
                                                        with Atmost
                                                        Care</span>
                                                </div>
                                            </div>
                                ...
                                <div class="col-span-12 xl:col-span-12 lg:col-span-12 !border-0">
                                    <div class="box">
                                        <div class="box-body">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <svg class="w-[3rem] h-[3rem] my-auto" id="SvgjsSvg1012"
                                                    xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    <defs id="SvgjsDefs1013"></defs>
                                                    <g id="SvgjsG1014"><svg xmlns="http://www.w3.org/2000/svg" id="svg6485"
                                                            ...
                                                            <g id="layer1" transform="translate(0 -1020.362)" fill="#6366f1"
                                                                ...
                                                                <path
                                                                    ...
                                                                    id="path12487" fill="#6366f1" fill-opacity="1"
                                                                    fill-rule="nonzero" stroke="none" stroke-dasharray="none"
                                                                    ...
                                                                    color-rendering="auto" display="inline"
                                                                    image-rendering="auto" opacity="1" shape-rendering="auto"
                                                                    text-rendering="auto" visibility="visible"
                                                                    class="color000 svgShape !fill-primary">
                                                                </path>
                                                            </g>
                                                        </svg></g>
                                                ...
                                                <div>
                                                    <span
                                                        class="block text-sm font-semibold dark:text-white max-w-[200px] truncate">Free
                                                        Delivery</span>
                                                    <span class="block text-xs text-gray-600 dark:text-white/70">100% free
                                                        charges on Every
                                                        Delivery</span>
                                                </div>
                                            </div>
                                ...
                                <div class="col-span-12 xl:col-span-12 lg:col-span-12 !border-0">
                                    <div class="box">
                                        <div class="box-body">
                                            <div class="flex space-x-3 rtl:space-x-reverse">
                                                <svg class="w-[3rem] h-[3rem] my-auto" id="SvgjsSvg1021"
                                                    xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                                    <defs id="SvgjsDefs1022"></defs>
                                                    <g id="SvgjsG1023"><svg xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 64 64">
                                                            <path
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#6366f1" class="color000 svgShape !fill-primary"></path>
                                                            <path d="M50.002 29.49H13.998a1 1 0 1 1 0-2h36.004a1 1 0 1 1 0 2z"
                                                                fill="#6366f1" class="color000 svgShape !fill-primary"></path>
                                                            <path
                                                                ...
                                                                fill="#6366f1" class="color000 svgShape !fill-primary"></path>
                                                            <path d="M47.002 24.488H16.998a1 1 0 1 1 0-2h30.004a1 1 0 1 1 0 2z"
                                                                fill="#6366f1" class="color000 svgShape !fill-primary"></path>
                                                            <path
                                                ...
                                                <div>
                                                    <span
                                                        class="block text-sm font-semibold dark:text-white max-w-[200px] truncate">Free
                                                        Returns</span>
                                                    <span class="block text-xs text-gray-600 dark:text-white/70">Cash Back
                                                        offers on every
                                                        purchase</span>
                                                </div>
                                            </div>
